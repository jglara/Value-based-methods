...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_size, hidden_1, hidden_2, action_size, seed):
        ...
        ======
            ...
            hidden_1 (int): Dimension of first hidden layer
            hidden_2 (int): Dimension of second hidden layer
            action_size (int): Dimension of each action
            seed (int): Random seed
        """
        super(QNetwork, self).__init__()
        self.seed = torch.manual_seed(seed)
        self.model = nn.Sequential(nn.Linear(state_size, hidden_1), nn.ReLU(),
...
class DQNAgent():
    ...
    def __init__(self, state_size, action_size, seed, device, **hparam):
        ...
        # Q-Network
        self.qnetwork_local = QNetwork(state_size, hparam["HIDDEN_1"], hparam["HIDDEN_2"], action_size, seed).to(device)
        self.qnetwork_target = QNetwork(state_size, hparam["HIDDEN_1"], hparam["HIDDEN_2"], action_size, seed).to(device)
